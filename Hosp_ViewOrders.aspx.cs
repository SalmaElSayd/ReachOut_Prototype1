...
namespace Reachout1
{
    public partial class Hosp_ViewOrders : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (rdr.Read())
            {
                ...
                int Order_id = rdr.GetInt32(rdr.GetOrdinal("id"));
                string Ord_id = (rdr.GetInt32(rdr.GetOrdinal("id"))).ToString();
